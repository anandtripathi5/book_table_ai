                                                    ...
                                                    <tbody><tr>
                                                        <td class="rnb-force-col" valign="top" style="padding-right: 0px;">
                                                            ...
                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                ...
                                                                <tbody><tr>
                                                                    <td style="font-size:14px; font-family:'Georgia',serif, sans-serif; color:#555; line-height: 21px;"><div style="text-align: center;"><span style="font-size:16px;"><span style="color:#e66f32;">
"""

email_content_part_2 = """"</span></span></div>
</td>
                                                                </tr>
                                                                </tbody></table>
